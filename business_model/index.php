                ...
                <div class="flex flex-col items-center justify-between xl:flex-row">
                    <div class="w-full max-w-xl mb-12 xl:pr-16 xl:mb-0 xl:w-7/12">
                        ...
                        <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-gray-100 sm:text-4xl sm:leading-none">
                            ...
                            top marketplace & community hub
                            <span class="inline-block text-cyan-500">Locommerce</span>
                        </h2>
                        <p class="text-base text-gray-400 md:text-lg">
                        Locommerce is a web based Marketplace & Community Hub platform which give power to build a strong online market and scale the business to higher level. Locommerce connecting the Customers & Local Business together at one Platform.
                    ...
                    <div class="px-5 pt-6 pb-5 text-center border border-gray-300 rounded lg:w-2/5">
                        ...
                        <a href="signup.php" class="inline-flex items-center justify-center w-full h-12 px-6 font-semibold transition duration-200 bg-white border border-gray-300 rounded md:w-auto hover:bg-gray-100 focus:shadow-outline focus:outline-none">
                            Sign Up with Email
                        </a>
                    </div>
                </div>
        ...
        <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
            <div class="flex flex-col lg:flex-row items-center">
                <div class="max-w-xl pr-16 mx-auto mb-10">
                    <h5 class="mb-6 text-3xl font-extrabold leading-none text-gray-100">
                        More about Locommerce
                    </h5>
                ...
                <div class="grid gap-5 row-gap-5 sm:grid-cols-2">
                    <!-- <div class="max-w-md">
                            ...
                            <h6 class="mb-2 font-semibold leading-5 text-cyan-500">End to End encrypted</h6>
                            <p class="text-sm text-gray-300">
                                We make sure all your data keep encrypted. No-one can access or change your data without your Permission.
                            </p>
                        </div> -->
                    <div class="max-w-md">
                        <div class="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-indigo-50">
                        ...
                        <h6 class="mb-2 font-semibold leading-5 text-cyan-500">Easy to connect with nearby shops.</h6>
                        <p class="text-sm text-gray-300">
                    ...
                    <div class="max-w-md">
                        ...
                        <h6 class="mb-2 font-semibold leading-5 text-cyan-500">Save quality time</h6>
                        <p class="text-sm text-gray-300">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut architecto neque, tempore temporibus saepe asperiores.
                        </p>
                    </div>
                    <div class="max-w-md">
                        <div class="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-indigo-50">
                        ...
                        <h6 class="mb-2 font-semibold leading-5 text-cyan-500">Buy now pay later</h6>
                        <p class="text-sm text-gray-300">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias ratione voluptatem quos eveniet, praesentium harum.
                        </p>
                    </div>
                    <div class="max-w-md">
                            <div class="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-indigo-50">
                            ...
                            <h6 class="mb-2 font-semibold leading-5 text-cyan-500">Secure checkout</h6>
                            <p class="text-sm text-gray-300">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium, fugit.
                            </p>
                        </div>
                </div>
            </div>
