          ...
          <div class="px-6 py-6 lg:px-8">
            ...
            <form class="space-y-6" action="#" method="POST" enctype="multipart/form-data">
              <div>
                ...
                <input type="email" name="email" id="email" class=" border text-sm rounded-lg  block w-full p-2.5 bg-gray-600 border-gray-500 placeholder-gray-400 text-white" value="Email" required>
              </div>
              <div>
                ...
                <div class="flex">
                  ...
                  <input type="text" id="username" name="username" onkeyup="nospaces(this)" maxlength="30" class="rounded-lg  block flex-1 min-w-0 w-full text-sm p-2.5  bg-gray-700 border-gray-600 placeholder-gray-400 text-white " value="Username">
              ...
              <div>
                ...
                <textarea id="about" name="about" maxlength="90" class="block p-2.5 w-full text-sm   rounded-lg border bg-gray-700 border-gray-600 placeholder-gray-400 text-white " maxlength="200">About</textarea>
            ...
            <form class="space-y-6" action="#" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-span-6 ml-2 sm:col-span-4 md:mr-3">
                ...
                <div class="text-center">
                  ...
                  <div class="mt-2">
                    <img src="images/user.jpeg" id="preview" class="w-40 h-40 m-auto rounded-full shadow">
                  </div>
...
<section class="bg-gray-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
  ...
  <?php require_once 'components/_navbar.php'; ?>
    ...
    <div class="border border-gray-200 rounded-lg shadow-md mx-auto mt-10">
      <div class="flex flex-col pl-5 py-10 items-center">
        <div class="flex">
          <div class="mb-3 flex flex-col items-center px-3">
            <img class="w-24 h-24 rounded-full shadow-lg" src="images/user.jpeg" alt="profile image" />
